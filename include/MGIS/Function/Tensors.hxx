...
namespace mgis::function{
  ...
  inline constexpr auto trace = internals::transform_modifier2(
  ...
  inline constexpr auto det = internals::transform_modifier2(
      []<typename TensorType>(const TensorType& t) requires(
          (tfel::math::TensorConcept<TensorType>) ||
          (tfel::math::StensorConcept<TensorType>)) {
  ...
  inline constexpr auto eigen_values = internals::transform_modifier2(
