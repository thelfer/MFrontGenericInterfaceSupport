...
namespace mgis {
  ...
  namespace fenics {
    ...
    NonLinearMaterialFunctionBase::NonLinearMaterialFunctionBase(
        NonLinearMaterial& nlm,
        std::shared_ptr<const dolfin::FiniteElement> elts)
        : m(nlm),
          elements(elts) {
    ...
    std::size_t NonLinearMaterialFunctionBase::value_rank() const {
      return this->elements->value_rank();
    }  // end of NonLinearMaterialFunctionBase::value_rank

    std::size_t NonLinearMaterialFunctionBase::value_dimension(
        const std::size_t i) const {
      return this->elements->value_dimension(i);
    }  // end of NonLinearMaterialFunctionBase::value_dimension

    std::vector<std::size_t> NonLinearMaterialFunctionBase::value_shape()
        const {
    ...
    void NonLinearMaterialFunctionBase::compute_vertex_values(
        std::vector<double>&, const dolfin::Mesh&) const {
      dolfin::error(
          "NonLinearMaterialFunctionBase::compute_vertex_values"
          " not implemented");
