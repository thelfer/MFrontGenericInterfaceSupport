...
class BoundsCheckTest(unittest.TestCase):
    ...
    def test_pass(self):
        ...
        self.assertTrue(abs(bound) < eps * yg_max,
                        "invalid value for the 'YoungModulus' "
        ...
        self.assertTrue(abs(bound - nu_min) < eps,
        ...
        self.assertTrue(abs(bound - nu_max) < eps * nu_max,
        ...
        self.assertTrue(abs(bound - iv_pmin) < eps,
        ...
        self.assertTrue(abs(bound - iv_pmax) < eps * iv_pmax,
                        "invalid value for the 'StateVariable' "
                        "physical upper bound")
        ...
        self.assertTrue(abs(bound - ev_min) < eps * ev_min,
                        "invalid value for the 'ExternalStateVariable' "
                        "lower bound")
        bound = mgis_bv.getUpperBound(b, ev)
        self.assertTrue(abs(bound - ev_max) < eps * ev_max,
                        "invalid value for the 'ExternalStateVariable' "
                        "upper bound")
        ...
        self.assertTrue(mgis_bv.hasLowerPhysicalBound(b, ev),
                        "'ExternalStateVariable' shall have a "
                        "lower physical bound")
        bound = mgis_bv.getLowerPhysicalBound(b, ev)
        self.assertTrue(abs(bound - ev_pmin) < eps,
                        "invalid value for the 'ExternalStateVariable' "
                        "physical lower bound")
        self.assertTrue(mgis_bv.hasUpperPhysicalBound(b, ev),
                        "'ExternalStateVariable' shall not have an "
                        "upper physical bound")
        bound = mgis_bv.getUpperPhysicalBound(b, ev)
        self.assertTrue(abs(bound - ev_pmax) < eps * ev_pmax,
                        "invalid value for the 'ExternalStateVariable' "
                        "physical upper bound")
