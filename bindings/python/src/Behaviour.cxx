...
static std::vector<mgis::behaviour::Variable> Behaviour_getInternalStateVariables(
    const mgis::behaviour::Behaviour& b) {
  return b.isvs;
} // end of Behaviour_getInternalStateVariables

static std::vector<mgis::behaviour::Variable> Behaviour_getExternalStateVariables(
    const mgis::behaviour::Behaviour& b) {
  return b.esvs;
...
void declareBehaviour(){
  ...
  boost::python::class_<Behaviour>("Behaviour")
      ...
      .add_property("behaviour_type", &Behaviour_getType,
                    "return the type of the behaviour")
      .add_property("kinematic", &Behaviour_getKinematic,
