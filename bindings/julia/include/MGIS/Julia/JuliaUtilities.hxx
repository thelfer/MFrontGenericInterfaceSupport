...
namespace jlcxx {
  ...
  //!
  template <>
  struct IsMirroredType<mgis::behaviour::Behaviour::BehaviourType> : std::true_type {};
  //!
  template <>
  struct IsMirroredType<mgis::behaviour::Behaviour::Kinematic> : std::true_type {};
  //!
  template <>
  struct IsMirroredType<mgis::behaviour::FiniteStrainBehaviourOptions::StressMeasure>
      : std::true_type {};
  //!
  template <>
  struct IsMirroredType<mgis::behaviour::FiniteStrainBehaviourOptions::TangentOperator>
      : std::true_type {};
  //! \brief
  template <>
