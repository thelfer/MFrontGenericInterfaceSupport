...
private:
 ...
 void test1() {
   ...
   auto op3 = getInternalStateVariable<1>(ctx, m, "EquivalentViscoplasticStrain");
   ...
   // invalid size
   auto op4 = getInternalStateVariable<4>(ctx, m, "EquivalentViscoplasticStrain");
   TFEL_TESTS_ASSERT(isInvalid(op4));
 }
};

TFEL_TESTS_GENERATE_PROXY(MaterialFunctionManagerTest, "MaterialFunctionManagerTest");
